...
| <a name="input_kubernetes_service_ipv4_cidr"></a> [kubernetes\_service\_ipv4\_cidr](#input\_kubernetes\_service\_ipv4\_cidr) | The CIDR block for the Kubernetes service | `string` | `"172.18.0.0/16"` | no |
